...
void MainWindow::on_actionsetsize_triggered()
{
    ...
    connect(size_Dialog,&TsizeDialog::set_rowcol,this,&MainWindow::set_colrow_slot);
    size_Dialog->exec();
    /*
...
void MainWindow::on_actionsetheader_triggered()
{
...
void MainWindow::on_actionsetitem_triggered()
{
    ...
    connect(set_item_Dialog,&setitemDialog::setitem_lineedit,this,&MainWindow::set_item_bysigal);
    connect(this,&MainWindow::set_spinbox_sigal,set_item_Dialog,&setitemDialog::tableview_click);
...
void MainWindow::set_item_bysigal(int col_current, int row_current, QString &text_temp)
{
...
void MainWindow::size_dialog_isable()
{
    ui->actionsetsize->setEnabled(true);
}

void MainWindow::set_colrow_slot(int col, int row)
{
    m_model->setColumnCount(col);
    m_model->setRowCount(row);
}

void MainWindow::size_dialog_noable()
{
