...
{
    emit now_triggered_label("setsize");
...
{
    emit now_triggered_label("setHeader");
...
{
    emit now_triggered_label("setitem");
    ...
    set_item_Dialog->setModal(false);  //表示可以操作主页面
}
